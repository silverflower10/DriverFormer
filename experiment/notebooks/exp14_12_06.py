...
from modules.running_hier import run_BORI_hier
from modules.data_preprocessing import preprocess_data
from modules.bayesian_decision import calculate_bayesian_fdr
import pandas as pd
...
results = run_BORI_hier(config, data, output_path)
...
output_csv_path = f"/home/silverflo/BORI/experiment/results/selected/{file_name}_op.pkl"
selected_results.to_csv(output_csv_path, index=False)
print(f"Selected results saved to '{output_csv_path}'")

# Print calculated FDR and optimal threshold
print(f"Optimal Threshold: {optimal_threshold:.4f}")
print(f"Bayesian FDR at Optimal Threshold: {fdr:.4f}")
